...
output1000 <- d[,c('lat','lon','day','cell1000','crime_bin')]
names(output1000) <- c('lat','lon','period','area','crime')
...
write.table(output1000,"/home/finn/phd/data/20140519/events1ks35b.txt",sep="|",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(a1000,"/home/finn/phd/data/20140519/cells1ks35.txt",sep="|",row.names=FALSE,col.names=TRUE,quote=FALSE)
