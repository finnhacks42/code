...
output5000 <- d[,c('lat','lon','week', 'cell5000','ones','crime_trunk','prem','ones')]
names(output1000) <- c('lat','lon','period','area','areaall','crime','prem','ones')
write.table(output1000,"/home/finn/phd/data/20140409/events5000_all.txt",sep="|",row.names=FALSE,col.names=TRUE,quote=FALSE)
write.table(a1000,"/home/finn/phd/data/20140409/cells5000.txt",sep="|",row.names=FALSE,col.names=TRUE,quote=FALSE)
